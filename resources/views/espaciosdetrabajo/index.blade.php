            ...
            <tbody>
                @forelse($espacios as $espacio)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('espaciosdetrabajo.show', $espacio) }}" class="btn btn-sm btn-outline-secondary">Ver</a>
                            <a href="{{ route('espaciosdetrabajo.edit', $espacio) }}" class="btn btn-sm btn-outline-primary">Editar</a>
