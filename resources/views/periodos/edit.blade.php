                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('periodos.update', $periodo) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nombre" class="form-control" value="{{ old('nombre', $periodo->nombre) }}">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Fecha inicio</label>
                            <input type="date" name="fecha_inicio" class="form-control" value="{{ old('fecha_inicio', $periodo->fecha_inicio) }}">
                        </div>
