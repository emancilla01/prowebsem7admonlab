            ...
            <div class="row">
                    ...
                    <div class="menu-card">
                        ...
                        @guest
                            <div class="small-list">
                                ...
                                <div style="margin-top:.6rem;"><a href="{{ route('login') }}">Login</a></div>
                        ...
                        @auth
                            <div class="small-list">
                                ...
                                <div style="color:#555; font-size:.9rem;">{{ auth()->user()->email }}</div>
                                <div style="margin-top:.6rem;"><a href="{{ url('/logout') }}">Logout</a></div>
                            </div>
                        @endauth
                    </div>
                </aside>
                ...
                <main class="col-12 col-md-8">
                    ...
                    <div class="menu3-card mt-3">
                        ...
                        @auth
                            <div><a href="{{ route('espaciosdetrabajo.index') }}">Espacios de Trabajo</a> &nbsp;|&nbsp; <a href="{{ route('grupos.index') }}">Alumnos</a></div>
                        @else
