...
<form action="<?php echo e(route('salidas.store')); ?>" method="POST">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="quien_autorizo" id="quien_autorizo" class="form-control" maxlength="100" value="<?php echo e(old('quien_autorizo')); ?>" required>
    </div>

    <div class="mb-3">
        <label for="quien_registro" class="form-label">Quien registró</label>
        <input type="text" name="quien_registro" id="quien_registro" class="form-control" maxlength="100" value="<?php echo e(old('quien_registro')); ?>" required>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('plantillas.login2', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Usuario\Herd\admonlab\resources\views/salidas/create.blade.php ENDPATH**/ ?>