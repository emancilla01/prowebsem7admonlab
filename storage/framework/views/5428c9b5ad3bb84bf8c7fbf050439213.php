...
<div class="container mt-4">
    ...
    <form action="<?php echo e(route('grupos.store')); ?>" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="clave_grupo" id="clave_grupo" class="form-control" value="<?php echo e(old('clave_grupo')); ?>" maxlength="50" required>
        </div>

        <div class="mb-3">
            <label for="nombre_grupo" class="form-label">Nombre</label>
            <input type="text" name="nombre_grupo" id="nombre_grupo" class="form-control" value="<?php echo e(old('nombre_grupo')); ?>" maxlength="100" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <select name="id_periodo" id="id_periodo" class="form-select" required>
                ...
                <?php $__currentLoopData = $periodos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $nombre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($id); ?>" <?php echo e(old('id_periodo') == $id ? 'selected' : ''); ?>><?php echo e($nombre); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        ...
        <div class="mb-3">
            ...
            <select name="id_personal" id="id_personal" class="form-select" required>
                ...
                <?php $__currentLoopData = $personals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $nombre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($id); ?>" <?php echo e(old('id_personal') == $id ? 'selected' : ''); ?>><?php echo e($nombre); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        ...
        <div class="mb-3">
            ...
            <select name="id_carrera" id="id_carrera" class="form-select" required>
                ...
                <?php $__currentLoopData = $carreras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $nombre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($id); ?>" <?php echo e(old('id_carrera') == $id ? 'selected' : ''); ?>><?php echo e($nombre); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="turno" id="turno" class="form-control" value="<?php echo e(old('turno')); ?>" maxlength="20">
        </div>
        ...
        <div class="mb-3">
            ...
            <select name="estatus" id="estatus" class="form-select" required>
                ...
                <option value="cerrado" <?php echo e(old('estatus') === 'cerrado' ? 'selected' : ''); ?>>Cerrado</option>
            </select>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('plantillas.login2', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Usuario\Herd\admonlab\resources\views/grupos/create.blade.php ENDPATH**/ ?>