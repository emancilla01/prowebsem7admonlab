...
<div class="container mt-4">
    <h2>Nuevo equipo (ECM: <?php echo e($id_ecm ?? '-'); ?>)</h2>

    <form action="<?php echo e(route('ecm_detequcom.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <a href="<?php echo e(route('ecm_detequcom.index', ['id_ecm' => $id_ecm])); ?>" class="btn btn-secondary">Cancelar</a>
        <button type="submit" class="btn btn-primary">Crear</button>
    </form>
</div>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('plantillas.login2', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Usuario\Herd\admonlab\resources\views/ecmdete/create.blade.php ENDPATH**/ ?>