                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('personal.store')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="rfc" class="form-control" value="<?php echo e(old('rfc')); ?>">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="apellido_pat" class="form-control" value="<?php echo e(old('apellido_pat')); ?>">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Apellido Materno</label>
                            <input type="text" name="apellido_mat" class="form-control" value="<?php echo e(old('apellido_mat')); ?>">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="sexo" class="form-select">
                                <?php $__currentLoopData = \App\Models\Personal::SEXO_VALUES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($s); ?>" <?php echo e(old('sexo') == $s ? 'selected' : ''); ?>><?php echo e(strtoupper($s)); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('plantillas.login2', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Usuario\Herd\admonlab\resources\views/personal/create.blade.php ENDPATH**/ ?>