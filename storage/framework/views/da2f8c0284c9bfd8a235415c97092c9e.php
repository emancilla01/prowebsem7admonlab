...
<div class="container mt-4">
    <h2>Nuevo mobiliario (ECM: <?php echo e($id_ecm ?? '-'); ?>)</h2>

    <form action="<?php echo e(route('ecm_detmob.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="id_ecm" value="<?php echo e($id_ecm); ?>">

        <div class="mb-3">
            <label for="codigo" class="form-label">Código</label>
            <input type="text" id="codigo" name="codigo" class="form-control" value="<?php echo e(old('codigo')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            ...
            <input type="text" id="material" name="material" class="form-control" value="<?php echo e(old('material')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            ...
            <input type="date" id="fecha_adquisicion" name="fecha_adquisicion" class="form-control" value="<?php echo e(old('fecha_adquisicion')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            ...
            <input type="text" id="ubicacion" name="ubicacion" class="form-control" value="<?php echo e(old('ubicacion')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <a href="<?php echo e(route('ecm_detmob.index', ['id_ecm' => $id_ecm])); ?>" class="btn btn-secondary">Cancelar</a>
        <button type="submit" class="btn btn-primary">Crear</button>
    </form>
</div>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('plantillas.login2', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Usuario\Herd\admonlab\resources\views/ecmdetm/create.blade.php ENDPATH**/ ?>